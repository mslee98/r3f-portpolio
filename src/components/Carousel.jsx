  ...
  return (
    <div className="relative">
                ...
                <div className="absolute w-full h-20 bottom-0 left-0 bg-black bg-opacity-90 px-5">
                  <div className="w-full h-full flex justify-between items-center">
                    ...
                    <div className="flex-center gap-5">
                      ...
                      <img
                        src="/assets/images/arrowupright.svg"
                        alt="arrow"
      ...
      <div className="mt-10 text-white-50 flex justify-end gap-5 md:-translate-x-32 -translate-x-5">
        <div
          onClick={prevSlide}
          className="rounded-full cursor-pointer bg-blue-200 hover:bg-pink-100 active:scale-90 transition-all w-12 h-12 flex items-center justify-center"
        >
          <img src="/assets/images/CaretLeft.svg" alt="left" className="w-5 h-5" />
        </div>
        <div
          onClick={nextSlide}
          className="rounded-full cursor-pointer bg-blue-200 hover:bg-pink-100 active:scale-90 transition-all w-12 h-12 flex items-center justify-center"
        >
          <img src="/assets/images/CaretRight.svg" alt="Right" className="w-5 h-5" />
        </div>
      </div>
    </div>
  );
