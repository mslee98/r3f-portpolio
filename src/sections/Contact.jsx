                    ...
                    <div className="relative w-full max-w-2xl bg-gradient-to-b from-[#1a1a2e] to-[#16213e] rounded-t-3xl transform translate-y-full animate-slide-up border border-gray-700/50 shadow-2xl">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <a href="https://mslee98pf.notion.site/?v=a65cd98d4a0e4c9c85214eb0acb17eb1" className="flex items-center justify-center space-x-2 p-4 bg-gray-800/50 rounded-xl border border-gray-700/30 hover:bg-gray-700/50 transition-colors duration-200">
